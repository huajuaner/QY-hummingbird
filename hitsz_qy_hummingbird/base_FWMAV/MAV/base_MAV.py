...
class BaseMAV:
    ...
    def __init__(self,
        ...
        p.setTimeStep(1 / self.params.timestep)
    ...
    def joint_state_update(self):
        ...
        self.right_stroke_acc = (vel - self.right_stroke_vel) * self.params.timestep
        self.right_stroke_vel = vel

        pos, vel, _, _ = p.getJointState(self.body_unique_id,
                                         self.left_stroke_joint)
        self.left_stroke_amp = pos
        self.left_stroke_acc = (vel - self.left_stroke_vel) * self.params.timestep
